...
export function Icon({ name, className = "" }) {
  return (
    <span className={`app-icon material-symbols-outlined ${className}`} aria-hidden="true" data-icon={iconFallbacksAscii[name] || iconFallbacks[name] || iconFallbacksAscii.default}>
      {name}
    </span>
  );
}
